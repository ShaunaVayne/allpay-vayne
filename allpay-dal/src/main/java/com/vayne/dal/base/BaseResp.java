package com.vayne.dal.base;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.vayne.dal.enums.ReturnCodeEnum;
...
public class BaseResp<T> implements Serializable {
     ...
     * 返回code
     */
    private Integer returnCode = 10000;                                  //默认成功
    ...
    public void fail(Throwable t) {
        if (t instanceof BaseException) {
            ...
            this.setReturnCode(ReturnCodeEnum.FAIL.getCode());
            this.setReturnMsg(ReturnCodeEnum.FAIL.getDesc());
        }
    }
